...
- **[User Manual](https://www.mithril-forge.site/documentation/user-manual)**: Learn how to manage encounters, track combat, and use the interface.
- **[Technical Documentation](https://www.mithril-forge.site/documentation/technical-docs)**: Find setup guides, CLI commands, tech stack details, and deployment instructions.
...
For full details, please refer to the [Development Setup guide](https://www.mithril-forge.site/documentation/technical-docs/how-to/development-setup).
